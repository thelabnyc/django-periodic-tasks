...
- bound re-enqueue with a redelivery lease (#34407)
- prevent re-enqueue storm for exactly-once tasks (#34407)
- **deps**: update dependency croniter to >=6.2.2
- **deps**: update dependency croniter to >=6.1.0

## v0.2.0 (2026-02-10)

### Feat

- support django-tasks 0.7.x alongside latest (0.12.0+)

### Fix

- **deps**: update dependency croniter to >=6.0.0

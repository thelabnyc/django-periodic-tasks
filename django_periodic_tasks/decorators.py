...
def exactly_once(func: Callable[..., Any]) -> Callable[..., Any]:
    ...
    the ``_execution_id`` keyword argument, this decorator will:

    1. Pop ``_execution_id`` from kwargs.
    ...
    If ``_execution_id`` is absent (e.g. manual invocation), the wrapped
    function runs normally without any execution-permit logic.
    """

    @functools.wraps(func)
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        execution_id: str | None = kwargs.pop("_execution_id", None)
